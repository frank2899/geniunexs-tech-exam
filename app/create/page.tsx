...
import { Link as ChakraLink, Box, Container, Fieldset, Flex, Input, NativeSelectRoot, Text, Button, chakra, useRecipe, Image } from '@chakra-ui/react'
...
const Page = () => {
    ...
    const { submitJob, isCreating } = useJob()
    ...
    const handleSave = async () => {
        if (previewData) await submitJob(previewData)
        reset()
        setIsOpen(false)
    }
    ...
    return (
        <DialogRoot motionPreset="slide-in-top" open={isOpen} onOpenChange={(e) => setIsOpen(e.open)}>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Fieldset.Root size="lg">
                        ...
                        <Fieldset.Content>
                            ...
                            <Button type="submit" size="lg" mt="4" fontFamily="poppins" disabled={isCreating} id="save-btn">
            ...
            <DialogContent maxWidth="1000px" bg="#fafafa">
                <DialogHeader>
                    <DialogTitle fontFamily="poppins">Job Preview</DialogTitle>
                </DialogHeader>
                <DialogBody id="job-draft">
                    <Box mb="30px">
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleSave} ml={3} disabled={isCreating}>
